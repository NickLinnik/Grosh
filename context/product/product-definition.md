...
- **Zero manual entry:** All Monobank transactions arrive automatically via webhook — no spreadsheet backfilling required.
...
- **Automatic transaction ingestion** — Monobank webhook receiver pushes transactions into a streaming pipeline in real time; manual accounts and cash can be entered by the user.
...
- Monobank webhook receiver and Redpanda-based transaction pipeline.
