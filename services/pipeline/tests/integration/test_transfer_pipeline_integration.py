"""Integration tests for the full PipelineOrchestrator with v2 transfer detection.
...
def _make_pipeline() -> "PipelineOrchestrator":
    """Wire up a complete PipelineOrchestrator with v2 Monobank transfer strategy."""
